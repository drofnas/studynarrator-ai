...
export const FileExportResultSchema = z
  .object({
...
export const ScriptGenerationPromptRequestSchema = z
  .object({
    projectId: ProjectIdSchema.nullable(),
    kind: ScriptPromptKindSchema,
  })
  .strict();
export const ScriptGenerationPromptExportRequestSchema = z
  .object({
    projectId: ProjectIdSchema.nullable(),
    kind: ScriptPromptKindSchema,
...
export const ScriptGenerationPromptInputSchema = z
  .object({ kind: ScriptPromptKindSchema })
  .strict();
export const ScriptGenerationPromptExportInputSchema = z
  .object({
    kind: ScriptPromptKindSchema,
    content: z.string().min(1).optional(),
  })
...
export const ScriptGenerationSkillRequestSchema = z
...
export interface ScriptGenerationClient {
  previewPrompt(
    ...
    kind: z.infer<typeof ScriptPromptKindSchema>,
