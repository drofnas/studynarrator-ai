...
export const KOKORO_VOICE_CATALOG_SOURCE =
  "https://huggingface.co/hexgrad/Kokoro-82M/blob/main/VOICES.md";
export const KOKORO_VOICE_CATALOG_ATTRIBUTION =
  "Kokoro-82M voice identifiers, Apache-2.0, hexgrad/Kokoro-82M.";
...
const groups = [
  ...
  },
  {
    language: "Japanese",
    locale: "ja-JP",
    ids: ["jf_alpha", "jf_gongitsune", "jf_nezumi", "jf_tebukuro", "jm_kumo"],
  },
  {
...
const entries: VoiceCatalogEntry[] = groups.flatMap((group) =>
  group.ids.map((voiceId) => ({
    ...
    locale: group.locale,
    accent:
      group.language === "American English"
        ? "American"
        : group.language === "British English"
          ? "British"
          : null,
    category: null,
    style: null,
...
export const BUNDLED_VOICE_CATALOGS: ReadonlyMap<string, VoiceCatalog> =
  new Map([[KOKORO_V1_MODEL_ID, KOKORO_V1_VOICE_CATALOG]]);
