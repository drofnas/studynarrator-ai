    ...
    <div className={styles.page}>
      ...
      {draft && project ? <>
        {activeTab === "settings" ? <section className={styles.lexiconPanel} aria-labelledby="project-lexicon-heading">
          ...
          <p className={styles.lexiconNote}>Script Text matches complete words regardless of capitalization. These pronunciations apply only to this project. <Link to="/settings/lexicon">Manage global lexicon in application Settings.</Link></p>
