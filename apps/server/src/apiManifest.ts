export const REST_API_MANIFEST = [
  ...
  { method: "PUT", path: "/api/renders/:renderId/pin" },
  { method: "GET", path: "/api/renders/:renderId/artifacts" },
  { method: "GET", path: "/api/renders/:renderId/audio" },
  { method: "GET", path: "/api/renders/:renderId/download" },
  { method: "GET", path: "/api/renders/:renderId/details" },
  ...
  { method: "GET", path: "/api/settings/retention" },
  { method: "PUT", path: "/api/settings/retention" },
  { method: "GET", path: "/api/settings/retention/usage" },
  { method: "POST", path: "/api/settings/retention/reclaim-preview" },
  { method: "POST", path: "/api/settings/retention/reclaim" },
  ...
  { method: "POST", path: "/api/connection/speech-catalog" },
  { method: "GET", path: "/api/connection/diagnostics" },
